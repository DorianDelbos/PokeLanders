...
namespace Landopedia
{
    ...
    public static class SaveSystem
    {
        ...
        private static readonly int MaxID = LanderRepository.Instance.GetAll().Length;
        ...
        public static void AddID(int newId)
        {
            ...
            {
                BitArray bitArray = LoadBitArray();
                bitArray[newId - 1] = true;
                SaveBitArray(bitArray);
            }
        }

        /// <summary>
        /// Clear the save by resetting the bitmask in PlayerPrefs.
        /// </summary>
        public static void Clear()
        {
            PlayerPrefs.DeleteKey(BitmaskKey);
            PlayerPrefs.Save();
        }
