...
namespace LandersLegends.Gameplay
{
    public class GameManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            string landerDebug2 = "00 00 00 02 4D 61 72 73 68 6D 61 6C 6C 6F 77 20 20 20 20 33 00 03 00 1A 00 00 02 14 00 43 00 20 00 01 00 00 00 00 00 00 0A 14 1E 28 32 3C 46 50 5A 64 6E 78";
