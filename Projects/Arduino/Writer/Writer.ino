...
void loop() 
{
  if (tagIsDetect())
  {
    // 00 00 00 01 41 62 63 64 65 66 67 68 69 6A 6B 6C 6D 6E FF 51 00 01 00 0A 00 00 00 40 00 0A 00 14 00 01 00 02 00 03 00 04 01 02 03 04 05 06 01 02 03 04 05 06
    uint8_t dataBlock1[16] = { 'S', 'M', 'a', 'r', 'i', 'o', 'B', 'r', 'o', 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x51};
